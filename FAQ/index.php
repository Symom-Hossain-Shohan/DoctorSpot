    ...
    <ul class="faq-text">
      <li>
        <div class="question-arrow">
          <span class="question">What does our platform do?</span>
      ...
      <li>
        <div class="question-arrow">
          <span class="question">How to find a doctor?</span>
          <i class="bx bxs-chevron-down arrow"></i>
        </div>
      ...
      <li>
        <div class="question-arrow">
          <span class="question">How to find a hospital?</span>
          <i class="bx bxs-chevron-down arrow"></i>
        </div>
      ...
      <li>
        <div class="question-arrow">
          <span class="question">What is predico?</span>
          <i class="bx bxs-chevron-down arrow"></i>
        </div>
