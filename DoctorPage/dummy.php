...
$con = mysqli_connect("localhost", "root", "", "ipproject") or die("Couldn't connect");
$sql1 = "SELECT * FROM doctor WHERE 1";
...
{
    $con = mysqli_connect("localhost", "root", "", "ipproject") or die("Couldn't connect");
    $sql1 = "SELECT * FROM doctor WHERE name LIKE '%$name%'";
    $all_docs = $con->query($sql1);
}
else if($name=="" && $dept == "")
{
    $con = mysqli_connect("localhost", "root", "", "ipproject") or die("Couldn't connect");
    $sql1 = "SELECT * FROM doctor WHERE location = '$loc'";
    $all_docs = $con->query($sql1);
}
else if($name=="" && $loc =="")
{
    $con = mysqli_connect("localhost", "root", "", "ipproject") or die("Couldn't connect");
    $sql1 = "SELECT * FROM doctor WHERE department = '$dept'";
    $all_docs = $con->query($sql1);
}
else if($name=="")
{
    $con = mysqli_connect("localhost", "root", "", "ipproject") or die("Couldn't connect");
    $sql1 = "SELECT * FROM doctor WHERE department = '$dept' AND location = '$loc'";
    $all_docs = $con->query($sql1);
}
else if($dept == "")
{
    $con = mysqli_connect("localhost", "root", "", "ipproject") or die("Couldn't connect");
    $sql1 = "SELECT * FROM doctor WHERE name LIKE '%$name%' AND location = '$loc'";
    $all_docs = $con->query($sql1);
}
else 
{
    $con = mysqli_connect("localhost", "root", "", "ipproject") or die("Couldn't connect");
    $sql1 = "SELECT * FROM doctor WHERE department = '$dept' AND name LIKE '%$name%'";
    $all_docs = $con->query($sql1);
}
