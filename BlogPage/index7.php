...
<body>
    ...
    <section class="about container" id="about">
        <div class="contentBx">
            <h2 class="titleText" style="font-size: 28px;">True friendship in life is always like a blessing</h2>
        ...
        <div class="imgBx">
            <img src="images/preview7.jpg" alt="" class="fitBg" style="height: 420px; width: 590px;">
        </div>
