...
<body>
    ...
    <section class="about container" id="about">
        <div class="contentBx">
            <h2 class="titleText" style="font-size: 28px;">Surprising link between health & mind</h2>
        ...
        <div class="imgBx">
            <img src="images/preview1.jpg" alt="" class="fitBg" style="height: 420px; width: 590px;">
        </div>
